defmodule Rubber.JSON do
  ...
  To override, implement the `Rubber.JSON.Codec` behavior and specify it in the config:
  ...
  defp json_options do
    ...
    case Rubber.config(:poison_options) do
      nil ->
        Rubber.config(:json_options, [])
  ...
  defp codec do
    Rubber.config(:json_codec, Poison)
  end
end
